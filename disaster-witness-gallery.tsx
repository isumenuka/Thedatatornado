...
// Local disaster assets
import tornadoVortex from "../../imports/disasters/tornado_vortex.png";
import ruinedLandscape from "../../imports/disasters/ruined_landscape.png";
import stormChasers from "../../imports/disasters/storm_chasers.png";
import rescueWorkers from "../../imports/disasters/rescue_workers.png";
import rebuiltCommunity from "../../imports/disasters/rebuilt_community.png";
            ...
            if (articles?.length) {
              const extra: NewsItem[] = articles.map((a: any, i: number) => {
                ...
                return {
                  ...
                  imageUrl: a.urlToImage || pool[Math.floor(Math.random() * pool.length)]?.imageUrl || tornadoVortex,
                  category,
                };
              });
          ...
          if (features?.length) {
            const alerts: NewsItem[] = features.map((f: any, i: number) => {
              ...
              return {
                ...
                imageUrl: pool[Math.floor(Math.random() * pool.length)]?.imageUrl || tornadoVortex,
                category: "vortex",
              };
            });
